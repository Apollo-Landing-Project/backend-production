...
export type GetMetadataAggregateType<T extends MetadataAggregateArgs> = {
    [P in keyof T & keyof AggregateMetadata]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateMetadata[P]> : Prisma.GetScalarType<T[P], AggregateMetadata[P]>;
};
...
type GetMetadataGroupByPayload<T extends MetadataGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<MetadataGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof MetadataGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], MetadataGroupByOutputType[P]> : Prisma.GetScalarType<T[P], MetadataGroupByOutputType[P]>;
}>>;
export type MetadataWhereInput = {
    ...
    destination?: Prisma.StringFilter<"Metadata"> | string;
    title_id?: Prisma.StringNullableFilter<"Metadata"> | string | null;
    title_en?: Prisma.StringNullableFilter<"Metadata"> | string | null;
    description_id?: Prisma.StringNullableFilter<"Metadata"> | string | null;
    description_en?: Prisma.StringNullableFilter<"Metadata"> | string | null;
...
export type MetadataScalarWhereWithAggregatesInput = {
    ...
    destination?: Prisma.StringWithAggregatesFilter<"Metadata"> | string;
    title_id?: Prisma.StringNullableWithAggregatesFilter<"Metadata"> | string | null;
    title_en?: Prisma.StringNullableWithAggregatesFilter<"Metadata"> | string | null;
    description_id?: Prisma.StringNullableWithAggregatesFilter<"Metadata"> | string | null;
    description_en?: Prisma.StringNullableWithAggregatesFilter<"Metadata"> | string | null;
...
export type MetadataOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "destination" | "title_id" | "title_en" | "description_id" | "description_en" | "createdAt" | "updatedAt", ExtArgs["result"]["metadata"]>;
...
export type MetadataCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<MetadataFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MetadataDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends MetadataCountArgs>(args?: Prisma.Subset<T, MetadataCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], MetadataCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends MetadataGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, MetadataGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMetadataGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface MetadataFieldRefs {
    ...
    readonly destination: Prisma.FieldRef<"Metadata", 'String'>;
    readonly title_id: Prisma.FieldRef<"Metadata", 'String'>;
    readonly title_en: Prisma.FieldRef<"Metadata", 'String'>;
    readonly description_id: Prisma.FieldRef<"Metadata", 'String'>;
    readonly description_en: Prisma.FieldRef<"Metadata", 'String'>;
